    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <h2 class="font-semibold text-xl mb-6">Ingatlan adatainak szerkesztese</h2>
                <form action="/properties/update" method="post">
                    {{ csrf_field() }}
                    <div class="grid items-end gap-6 mb-6 md:grid-cols-3">
                        <div class="relative">
                            <input required type="text" id="small_filled" class="required block rounded-t-lg px-2.5 pb-1.5 pt-4 w-full text-sm text-gray-900 bg-gray-50 dark:bg-gray-700 border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " value="{{ $proper['title'] }}" name="title" />
                    ...
                    <input type="hidden" name="id" value="{{ $proper['id'] }}">


                    <div class="grid items-end gap-6 mb-6 md:grid-cols-3">
                        <div class="relative">
                            <input required type="text" id="small_filled" class=" block rounded-t-lg px-2.5 pb-1.5 pt-4 w-full text-sm text-gray-900 bg-gray-50 dark:bg-gray-700 border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " value="{{ $proper['price_per_night'] }}" name="price_per_night" />
                    ...
                    <div class="grid items-end gap-6 mb-6 md:grid-cols-3">
                        <div class="relative">
                            <textarea id="small_filled" class="block rounded-t-lg px-2.5 pb-1.5 pt-4 w-full text-sm text-gray-900 bg-gray-50 dark:bg-gray-700 border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " name="description">{{ $proper['description'] }}</textarea>
                    ...
                    <div class="mt-4">
                        ...
                        <button class="relative bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded pl-[35px]" type="submit">

                            Adatok mentése
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-[15px] top-[8px] left-[10px] absolute w-6 h-6">
                                <path fill-rule="evenodd" d="M4.125 3C3.089 3 2.25 3.84 2.25 4.875V18a3 3 0 0 0 3 3h15a3 3 0 0 1-3-3V4.875C17.25 3.839 16.41 3 15.375 3H4.125ZM12 9.75a.75.75 0 0 0 0 1.5h1.5a.75.75 0 0 0 0-1.5H12Zm-.75-2.25a.75.75 0 0 1 .75-.75h1.5a.75.75 0 0 1 0 1.5H12a.75.75 0 0 1-.75-.75ZM6 12.75a.75.75 0 0 0 0 1.5h7.5a.75.75 0 0 0 0-1.5H6Zm-.75 3.75a.75.75 0 0 1 .75-.75h7.5a.75.75 0 0 1 0 1.5H6a.75.75 0 0 1-.75-.75ZM6 6.75a.75.75 0 0 0-.75.75v3c0 .414.336.75.75.75h3a.75.75 0 0 0 .75-.75v-3A.75.75 0 0 0 9 6.75H6Z" clip-rule="evenodd" />
                                <path d="M18.75 6.75h1.875c.621 0 1.125.504 1.125 1.125V18a1.5 1.5 0 0 1-3 0V6.75Z" />
                            </svg>
                        </button>
                        @if($user->id == 1)
                        <a href="/properties/delete/{{$proper['id']}}">

                            <button class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded pl-[35px] relative" type="button">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-[17px] left-[8px] absolute w-6 h-6">
